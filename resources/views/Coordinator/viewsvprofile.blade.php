...
<h1>Dashboard</h1>
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href='/viewsvprofile'>View Supervisor's Profile</a></li>
        </ol>
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form action="/updatesupervisor/{{$detaa->sid}}" method='post' enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
